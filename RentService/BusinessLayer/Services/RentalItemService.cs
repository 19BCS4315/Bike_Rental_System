...
namespace BikeRentalSystem.RentService.BusinessLayer.Services
{
    public class RentalItemService : IRentalItemService
    {
        ...
        public RentalItemService(IRentalItemRepository rentalItemRepository, IBikeRepository bikeRepository)
        {
        ...
        {
            var rentalItems = _rentalItemRepository.GetAllRentalItems().Where(r => r.BikeId == bikeId);
            return rentalItems.Select(r => ToRentalItemDto(r));
        }
